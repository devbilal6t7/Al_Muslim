...
class NamesDetail extends StatefulWidget {
  const NamesDetail({super.key, required this.name});
  final NameModel name;

  @override
  State<NamesDetail> createState() => _NamesDetailState();
}

class _NamesDetailState extends State<NamesDetail> {
